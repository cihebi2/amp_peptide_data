...
- paper_id: `doi__10.3390_antibiotics12030551`
- review_sample_id: `V420P0175`
- sampled validation rows for this paper: `1`
- packet directory: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551`
- validation samples: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/validation_samples.json`
- release rows: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/release_rows.json`
- sample final records: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/sample_final_records.json`
- source locator hints: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/source_locator_hints.json`
- material inventory: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/material_inventory.json`
- result schema: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/true_review_result.schema.json`
- write result JSON: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/true_review_result.json`
- if hard failures exist, write tickets JSONL: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/rework_tickets.jsonl`
...
Write `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0175__doi__10.3390_antibiotics12030551/true_review_result.json` as JSON matching the schema. Keep final chat response short and point to the result path.
