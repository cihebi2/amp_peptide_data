...
- review_sample_id: `V420P0005`
- sampled validation rows for this paper: `1`
- packet directory: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x`
- validation samples: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/validation_samples.json`
- release rows: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/release_rows.json`
- sample final records: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/sample_final_records.json`
- source locator hints: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/source_locator_hints.json`
- material inventory: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/material_inventory.json`
- result schema: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/true_review_result.schema.json`
- write result JSON: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/true_review_result.json`
- if hard failures exist, write tickets JSONL: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/rework_tickets.jsonl`
...
Write `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0005__doi__10.1007_s12539-016-0163-x/true_review_result.json` as JSON matching the schema. Keep final chat response short and point to the result path.
