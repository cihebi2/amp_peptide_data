...
- paper_id: `doi__10.1038_s41422-020-0305-x`
- review_sample_id: `V420P0029`
- sampled validation rows for this paper: `2`
- packet directory: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x`
- validation samples: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/validation_samples.json`
- release rows: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/release_rows.json`
- sample final records: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/sample_final_records.json`
- source locator hints: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/source_locator_hints.json`
- material inventory: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/material_inventory.json`
- result schema: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/true_review_result.schema.json`
- write result JSON: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/true_review_result.json`
- if hard failures exist, write tickets JSONL: `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/rework_tickets.jsonl`
...
Write `reports/nar_resource_freeze_v1/manual_validation/validation420/source_review_packets/V420P0029__doi__10.1038_s41422-020-0305-x/true_review_result.json` as JSON matching the schema. Keep final chat response short and point to the result path.
