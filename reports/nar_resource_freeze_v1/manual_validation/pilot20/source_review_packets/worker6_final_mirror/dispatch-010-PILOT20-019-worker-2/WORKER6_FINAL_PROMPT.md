...
- dispatch_id: `dispatch-010-PILOT20-019-worker-2`
- paper_id: `doi__10.1038_s41598-017-16784-6`
- owner_worker: `worker-2_main_text_assay_extractor`
- owner action: `needs_upstream_material`
- owner response: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/owner_rework_dispatch/dispatch-010-PILOT20-019-worker-2/owner_response.json`
- dispatch packet: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/owner_rework_dispatch/dispatch-010-PILOT20-019-worker-2/dispatch_packet.json`
- source review packet: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-019__doi__10.1038_s41598-017-16784-6`
- write response JSON: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/worker6_final_mirror/dispatch-010-PILOT20-019-worker-2/worker6_final_response.json`
- response schema: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/worker6_final_mirror/dispatch-010-PILOT20-019-worker-2/worker6_final_response.schema.json`
...
4. Write `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/worker6_final_mirror/dispatch-010-PILOT20-019-worker-2/worker6_final_response.json` matching schema with:
   - `final_decision`
   - `files_updated`
   - `qc_summary`
   - `remaining_blockers`
