...
- readjudicated_decision: `accepted_with_cautions_confirmed`
- readjudication_reason_code: `cautions_preserved`
- original_decision: `accepted_with_cautions_confirmed`
- audit_record_id: `doi__10.1038_s41467-017-00419-5:database_audit:107`
- true review result: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-006__doi__10.1038_s41467-017-00419-5/true_review_result.json`
- review packet: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-006__doi__10.1038_s41467-017-00419-5`
- current paper final dir: `papers/doi__10.1038_s41467-017-00419-5/final/`
- packet final dir: `paper_packets/doi__10.1038_s41467-017-00419-5/final/`
- write response JSON: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/worker6_non_dispatch_final_review/PILOT20-006__doi__10.1038_s41467-017-00419-5/worker6_non_dispatch_final_response.json`
- response schema: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/worker6_non_dispatch_final_review/PILOT20-006__doi__10.1038_s41467-017-00419-5/worker6_non_dispatch_final_response.schema.json`
...
3. For safe acceptance:
   ...
   - Update `papers/doi__10.1038_s41467-017-00419-5/final/review_report.json` and `paper_packets/doi__10.1038_s41467-017-00419-5/final/review_report.json` with worker-6 provenance, checked inputs, semantic QA summary, preserved cautions, and zero hard rework targets.
...
5. Write `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/worker6_non_dispatch_final_review/PILOT20-006__doi__10.1038_s41467-017-00419-5/worker6_non_dispatch_final_response.json` matching schema with `final_decision`, `files_updated`, `qc_summary`, `remaining_blockers`, and `worker6_followup`.
