...
- packet directory: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x`
- validation sample: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/validation_sample.json`
- release row: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/release_row.json`
- sample final record: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/sample_final_record.json`
- source locator hints: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/source_locator_hints.json`
- material inventory: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/material_inventory.json`
- result schema: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/true_review_result.schema.json`
- write final result to: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/true_review_result.json`
- if hard failure, write rework ticket to: `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/rework_ticket.json`

## Sample identity

- pilot_sample_id: `PILOT20-001`
- paper_id: `doi__10.1007_s12539-016-0163-x`
- database/source_id: `DBAASP / DBAASP:DBAASPS_12357`
- audit_record_id: `doi__10.1007_s12539-016-0163-x:database_audit:56`
- status under review: `source_verified`
- categories: `activity_value_or_unit;database_only_no_primary_source;sequence_or_modification;target_or_organism;unresolved_or_missing_material`
...
1. Re-open `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/material_inventory.json` and verify which XML/PDF/OA/supplement/database-row surfaces actually exist.
...
4. For layer 1, decide whether the status `source_verified` is justified. Do not turn conflicts into clean source_verified.
...
Write `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/true_review_result.json` as JSON matching `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/true_review_result.schema.json`.

If `decision` is `needs_targeted_rework` or `blocked_missing_primary_material`, also write `reports/nar_resource_freeze_v1/manual_validation/pilot20/source_review_packets/PILOT20-001__doi__10.1007_s12539-016-0163-x/rework_ticket.json` with:
