...
You are a new Codex CLI paper-review worker for Batch 4-Team. Re-review exactly one paper: `doi__10.1371_journal.pone.0167953`.
...
- Treat `rework_context/doi__10.1371_journal.pone.0167953/handoff_context.json` as the message packet and reopen the source/artifact paths listed there.
...
- packet_manifest: `paper_packets/doi__10.1371_journal.pone.0167953/packet_manifest.json`
- locator_index: `paper_packets/doi__10.1371_journal.pone.0167953/locators/locator_index.json`
- extraction_status: `paper_packets/doi__10.1371_journal.pone.0167953/extraction/extraction_status.json`
- extraction_quality_report: `paper_packets/doi__10.1371_journal.pone.0167953/extraction/extraction_quality_report.json`
- analysis_status: `paper_packets/doi__10.1371_journal.pone.0167953/analysis/analysis_status.json`
- packet_activity: `paper_packets/doi__10.1371_journal.pone.0167953/analysis/activity_toxicity_evidence.json`
- packet_database: `paper_packets/doi__10.1371_journal.pone.0167953/analysis/database_record_audit.json`
- packet_mechanism: `paper_packets/doi__10.1371_journal.pone.0167953/analysis/mechanism_evidence.json`
- packet_adjudication: `paper_packets/doi__10.1371_journal.pone.0167953/analysis/adjudication_report.json`
- rework_requests: `paper_packets/doi__10.1371_journal.pone.0167953/rework/rework_requests.jsonl`
- rework_responses: `paper_packets/doi__10.1371_journal.pone.0167953/rework/rework_responses.jsonl`
- final_review_report: `papers/doi__10.1371_journal.pone.0167953/final/review_report.json`
- final_activity: `papers/doi__10.1371_journal.pone.0167953/final/activity_toxicity_evidence.json`
- final_database: `papers/doi__10.1371_journal.pone.0167953/final/database_record_verification.json`
- final_mechanism: `papers/doi__10.1371_journal.pone.0167953/final/mechanism_ontology_record.json`
- quality_feedback: `papers/doi__10.1371_journal.pone.0167953/work/review/quality_feedback.json`
- workflow_context: `.miaobi-paper-review/workflows/doi__10.1371_journal.pone.0167953/workflow_context.json`
- state_executions: `.miaobi-paper-review/workflows/doi__10.1371_journal.pone.0167953/state_executions.jsonl`
- chat_messages: `.miaobi-paper-review/workflows/doi__10.1371_journal.pone.0167953/chat_messages.jsonl`
- agent_logs: `.miaobi-paper-review/workflows/doi__10.1371_journal.pone.0167953/agent_logs.jsonl`
- latest_complete_report: `reports/doi__10.1371_journal.pone.0167953.complete_message_test_report.json`

## Required Output

1. Repair the owner-layer artifact(s) under the paper-local packet/final/work paths.
2. Update `paper_packets/doi__10.1371_journal.pone.0167953/rework/rework_responses.jsonl` with what was checked and what remains.
3. Update `papers/doi__10.1371_journal.pone.0167953/work/review/quality_feedback.json` if final QC still fails, with concrete `qc_failure_reasons`.
