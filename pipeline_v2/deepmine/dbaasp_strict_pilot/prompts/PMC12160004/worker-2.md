...
- Runtime-open ticket IDs assigned to worker-2: ["rwk-PMC12160004-campaign-r01-BF-PMC12160004-W2-ZEBRAFISH-BODY-LENGTH-OMISSION"]
- Runtime-open ticket contracts assigned to worker-2: [
  {
    "acceptance_checks": [
      "A read-only query over final/activity_toxicity_evidence.json returns at least one toxicity record or explicit exclusion whose endpoint/reason mentions zebrafish body length or Fig. 11f development length and whose source_locators include xml:p:40 and xml:fig:11.",
      "The repaired object does not invent exact numeric body-length values unless they are digitized with approximate status and uncertainty or directly source-reported.",
      "review_report semantic_quality_checks.open_rework_ticket_count equals the live packet rework state, rework_targets is empty only after this repair, and paper/packet final mirrors remain byte-identical for same-name JSON files."
    ],
    "blocks": [
    ...
    "created_at": "2026-07-27T21:09:20.972840Z",
    "evidence_paths": [
      "pipeline_v2/deepmine/dbaasp_strict_pilot/reports/remaining_200_campaign/PMC12160004/20260727T205955652929Z.leader_semantic_auditor.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12160004/source/paper.xml",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12160004/source/paper.pdf",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12160004/final/activity_toxicity_evidence.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12160004/final/review_report.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12160004/work/activity_evidence/zebrafish_p40_quantitative_binding.worker2.sanitized.json"
    ],
    "leader_finding_fingerprint": "ea596a0e685ad5f839b328eb0f6bd2385d7fe92d028a3eb313a4a914151b83d9",
    "leader_finding_id": "BF-PMC12160004-W2-ZEBRAFISH-BODY-LENGTH-OMISSION",
    ...
    "reason": "Layer-2 toxicity/selectivity coverage is incomplete. The primary source states that zebrafish body length was measured after treatment and Fig. 11f reports the 5-day development/body-length result; xml:p:40 specifically reports slight D-A3 body-length decrease at 6 μg/mL and no significant body-length differences for triazole-containing peptides versus A3/negative controls. Current final activity_toxicity_evidence.json has 11 toxicity records for hemolysis and hatching only, with no body-length/development-length record or explicit source-located exclusion, while review_report claims toxicity_source_surfaces_covered=true.",
    "requested_by": "structured_leader_field_level_semantic_audit",
    "required_actions": [
      "Add a source-located toxicity/development coverage object for Fig. 11f body-length evidence, or add a source-located explicit exclusion explaining why no row-level record is scientifically supportable.",
      "Preserve endpoint, treatment, target Danio rerio/zebrafish embryos, concentration/timepoint when source-supported, raw value/unit or qualitative/no-unit rationale, exact-vs-approximate status, and primary-source locators.",
      "Update both final mirrors and worker-6 review_report so toxicity_source_surfaces_covered and final_counts reflect the repaired live state."
    ],
    "severity": "blocking",
    "source_locators": [
      "xml:p:26",
      ...
      "xml:fig:11",
      "xml:caption:13",
      "pdf:page=10:figure=11f"
    ],
    "target_queue": "analysis",
    "ticket_id": "rwk-PMC12160004-campaign-r01-BF-PMC12160004-W2-ZEBRAFISH-BODY-LENGTH-OMISSION"
  }
]
...
Write:
- pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12160004/work/activity_evidence/activity_records.json
- pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12160004/analysis/activity_toxicity_evidence.worker2.json
...
- pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12160004/analysis/activity_safe_candidate_handoff.json
