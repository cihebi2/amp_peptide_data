...
- Runtime-open ticket IDs assigned to worker-4: ["rwk-PMC12160004-campaign-r01-BF-PMC12160004-W4-001"]
- Runtime-open ticket contracts assigned to worker-4: [
  {
    "acceptance_checks": [
      "reports/PMC12160004_strict_acceptance_audit_latest.json shows strict_worker_run_hard_finding_count 0 for PMC12160004.",
      "A recursive scan of database_record_verification.json, database_record_audit.worker4.json, and record_identity_audit.json finds no source_locator/source_locators value beginning with pipeline_v2/deepmine/dbaasp_strict_pilot or pointing to packet/work/final artifacts.",
      "Database final mirrors remain byte-identical after repair and authoritative_dbaasp_ingest_ready remains false unless real linked authoritative rows are added."
    ],
    "blocks": [
    ...
    "created_at": "2026-07-27T12:38:22.616593Z",
    "evidence_paths": [
      "pipeline_v2/deepmine/dbaasp_strict_pilot/reports/remaining_200_campaign/PMC12160004/20260727T122808305241Z.leader_semantic_auditor.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/reports/PMC12160004_strict_acceptance_audit_latest.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12160004/final/database_record_verification.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12160004/final/database_record_verification.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12160004/analysis/database_record_audit.worker4.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12160004/work/database_record_audit/record_identity_audit.json"
    ],
    ...
    "reason": "The current strict acceptance artifact reports 210 hard recursive_non_source_locator_reference findings in worker-4 database artifacts and both database final mirrors. The database citation_traceability.source_locators fields point to packet_manifest.json, database_source_manifest.json, and authoritative_match_report.json instead of primary-source/database-row locators, while final review_report still reports publication_grade true and zero rework targets. These hard findings are current and unreconciled.",
    "requested_by": "structured_leader_field_level_semantic_audit",
    "required_actions": [
      "Move packet/database artifact paths out of source_locator/source_locators fields into checked_inputs or database_provenance fields.",
      "Replace citation traceability source_locators with primary-source identifiers, paper-local locators, or explicit database-row provenance locators; preserve unresolved_record and sequence_modified_not_normalized statuses where authoritative rows remain absent.",
      "Rerun strict acceptance after repair and do not mark publication_grade true until recursive_non_source_locator_reference count is zero."
    ],
    "severity": "blocking",
    "source_locators": [
      "xml:article-title:1",
      "xml:article-id doi 10.1039/d5ra02745d",
      "xml:article-id pmid 40510052",
      "xml:p:13 A3 sequence",
      "xml:p:14 disulfide cyclization",
      "xml:p:15-16 triazole substitutions"
    ],
    "target_queue": "database",
    "ticket_id": "rwk-PMC12160004-campaign-r01-BF-PMC12160004-W4-001"
  }
]
