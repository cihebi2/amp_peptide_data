...
- Runtime-open ticket IDs assigned to worker-2: ["rwk-PMC12124432-campaign-r02-PMC12124432-BLOCK-002"]
- Runtime-open ticket contracts assigned to worker-2: [
  {
    "acceptance_checks": [
      "A row-count audit enumerates Table 1 plus Tables S3, S4, S5, S6, and S7 and every source-reviewable endpoint cell is represented or explicitly excluded with a source-backed reason.",
      "No Table 1 MIC row has null assay_medium or missing pH/incubation/temperature when table footnote a is present.",
      "toxicity_records contains HK-2 cell-line IC50 records from Table S5 and no target field contains an embedded table footnote marker such as b)."
    ],
    "blocks": [
    ...
    "created_at": "2026-07-27T20:19:48.243408Z",
    "evidence_paths": [
      ...
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12124432/work/activity_evidence/activity_records.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12124432/analysis/activity_toxicity_evidence.worker2.json",
    ...
    "leader_finding_fingerprint": "31ece9f3ea3fbf5210bba70b2488e7b62ee8344b72bc89aa1a5dcd65d26656fb",
    "leader_finding_id": "PMC12124432-BLOCK-002",
    ...
    "reason": "Activity/toxicity final is materially incomplete. It emits only 56 XML Table 1 MIC records and 16 toxicity records, while source-reviewable supplementary Tables S3, S4, S6, and S7 contain additional MIC/MHC rows and Table S5 contains an HK-2 IC50 row that is absent from final toxicity_records. Table 1 assay conditions are reported in the source but final activity rows have assay_medium and condition_note null; MDR footnote b remains embedded in strain text.",
    "requested_by": "structured_leader_field_level_semantic_audit",
    "required_actions": [
      "Rebuild activity_toxicity_evidence from all source-reviewed main-text and supplementary endpoint tables, not only XML Table 1.",
      "Populate reported assay conditions for MIC rows, including medium, pH, incubation time, temperature, duplicate determination note, salt condition where applicable, and MHC/cell-viability assay conditions where reported.",
      "Emit Table S5 HK-2 IC50 row-level records and normalize footnote markers such as MDR note b out of strain fields into separate condition/annotation fields."
    ],
    "severity": "blocking",
    "source_locators": [
      "xml:table-wrap:1:table-fn=a",
      "xml:table-wrap:1:body-row=2:table-fn=b",
      "xml:fig:2:caption:b",
      "supp:ANIE-64-e202501299-s002.pdf:page=21:Table S3",
      "supp:ANIE-64-e202501299-s002.pdf:page=23:Table S4",
      "supp:ANIE-64-e202501299-s002.pdf:page=25:Table S5 HK-2 row",
      "supp:ANIE-64-e202501299-s002.pdf:page=33:Table S6",
      "supp:ANIE-64-e202501299-s002.pdf:page=34:Table S7"
    ],
    "target_queue": "analysis",
    "ticket_id": "rwk-PMC12124432-campaign-r02-PMC12124432-BLOCK-002"
  }
]
...
- pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12124432/analysis/activity_safe_candidate_handoff.json
