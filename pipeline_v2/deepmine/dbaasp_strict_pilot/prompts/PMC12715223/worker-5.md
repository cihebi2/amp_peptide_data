...
- Runtime-open ticket IDs assigned to worker-5: ["rwk-PMC12715223-campaign-r01-BF-PMC12715223-W5-MECH-001"]
- Runtime-open ticket contracts assigned to worker-5: [
  {
    "acceptance_checks": [
      "strict_worker_run_gate hard_finding_count is zero for PMC12715223 with no recursive_non_source_locator_reference findings.",
      "No mechanism source_locator or supporting_source_locators value contains a project JSON path, URI fragment, or #activity_records reference.",
      "surface_plasmon_resonance_binding_assay is absent unless paired with a source-local SPR locator; docking-only locators remain computational_only or inferred_mechanism."
    ],
    "blocks": [
    ...
    "created_at": "2026-07-27T10:32:34.071430Z",
    "evidence_paths": [
      ...
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12715223/source/paper.xml",
      ...
      "pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12715223/analysis/mechanism_evidence.worker5.json"
    ],
    ...
    "reason": "Mechanism ontology violates source-boundary requirements: the current strict acceptance artifact reports five hard recursive_non_source_locator_reference findings for mechanism claim 004, and claim 001 promotes pMurD-MurD target recognition to direct_mechanism via surface_plasmon_resonance_binding_assay even though the cited primary/supplementary surfaces describe molecular docking/design evidence rather than SPR binding.",
    "requested_by": "structured_leader_field_level_semantic_audit",
    "required_actions": [
      "Replace recursive artifact-path supporting locators with primary XML/PDF/supplement locators for claim 004.",
      "Re-audit claim 001 and remove surface_plasmon_resonance_binding_assay unless a primary source locator actually reports SPR; otherwise downgrade the pMurD-MurD recognition evidence to computational_only or inferred_mechanism as appropriate.",
      "Verify every direct_mechanism claim has a direct assay type that is explicitly supported by its cited source locators."
    ],
    "severity": "blocking",
    "source_locators": [
      "strict_acceptance_audit_latest.json strict_worker_run_gate findings code=recursive_non_source_locator_reference",
      "final mechanism_ontology_record.json $/mechanism_claims/3/supporting_source_locators",
      "non_source_locator=pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12715223/analysis/activity_toxicity_evidence.worker2.json#activity_records",
      "final mechanism_ontology_record.json $/mechanism_claims/0/direct_assay_types",
      "xml:p:7",
      "xml:caption:2",
      "supp:41467_2025_66221_MOESM1_ESM.pdf:page=2",
      "xml:p:64"
    ],
    "target_queue": "mechanism",
    "ticket_id": "rwk-PMC12715223-campaign-r01-BF-PMC12715223-W5-MECH-001"
  }
]
...
Write:
- pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12715223/work/mechanism_ontology/mechanism_evidence.json
- pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12715223/analysis/mechanism_evidence.worker5.json
