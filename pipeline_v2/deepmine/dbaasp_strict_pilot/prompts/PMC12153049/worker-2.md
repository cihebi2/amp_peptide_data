...
- Runtime-open ticket IDs assigned to worker-2: ["rwk-PMC12153049-campaign-r01-BF-PMC12153049-W2-SUPP-TOXICITY-SURFACE-COVERAGE-CONFLATION"]
- Runtime-open ticket contracts assigned to worker-2: [
  {
    "acceptance_checks": [
      "A script over paper-final and packet-final activity_toxicity_evidence.json asserts no source_surface_coverage source_locator matches the page-less pattern supp:RA-015-D5RA02932E-s001.pdf:figure=*.",
      "For S14, S15, S16, and S17, the same script computes toxicity_record_ids from row source_locator/supporting_locators and exactly matches the corresponding source_surface_coverage toxicity_record_ids.",
      "The computed surface mappings are S14: PMC12153049-W2-TOX-001; S15: PMC12153049-W2-TOX-002; S16: PMC12153049-W2-TOX-007 and PMC12153049-W2-TOX-008; S17: PMC12153049-W2-TOX-003 through PMC12153049-W2-TOX-006, with organ-H&E kept under Fig. 6/xml:p:22 rather than S17.",
      "Paper-final and packet-final activity_toxicity_evidence.json remain byte-identical after repair, and semantic/publication gates are rerun without allow flags."
    ],
    "blocks": [
    ...
    "created_at": "2026-07-27T20:59:48.042283Z",
    "evidence_paths": [
      "pipeline_v2/deepmine/dbaasp_strict_pilot/reports/remaining_200_campaign/PMC12153049/20260727T204907351210Z.leader_semantic_auditor.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12153049/final/activity_toxicity_evidence.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12153049/final/activity_toxicity_evidence.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12153049/extracted/supplementary_tables.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12153049/locators/locator_index.json",
      "pipeline_v2/deepmine/dbaasp_strict_pilot/papers/PMC12153049/source/supplementary/RA-015-D5RA02932E-s001.pdf"
    ],
    "leader_finding_fingerprint": "543c642abb7c3ee8daf00f5d2d34d4ca4f41fdccf5dadf544ab0575d0c26f322",
    "leader_finding_id": "BF-PMC12153049-W2-SUPP-TOXICITY-SURFACE-COVERAGE-CONFLATION",
    ...
    "reason": "The final activity_toxicity_evidence.json cannot support publication-grade toxicity/selectivity coverage because source_surface_coverage and quality_checks.worker6_core_contract_validation.s14_s17_contract conflate supplement surfaces. The source shows S15 is LDH release, S16 is body-weight change, and S17 is hemolysis; however final source_surface_coverage lists body-weight records under S15, hemolysis records under S16, and organ-H&E under S17, and S14-S17 coverage locators omit page coordinates. This is a material field-level locator/count error, not an infrastructure failure.",
    "requested_by": "structured_leader_field_level_semantic_audit",
    "required_actions": [
      "Rebuild activity_toxicity_evidence.json source_surface_coverage so each S14-S17 entry uses a page-qualified supplement locator and only lists toxicity_record_ids whose primary or supporting locator actually references that surface.",
      "Recompute worker6_core_contract_validation.s14_s17_contract final_rows_with_surface_locator from the repaired row-to-surface mapping rather than from substring or stale coverage counts.",
      "Keep approximate graph observations and documented exclusions, but bind them to the correct source surface: S14 BEAS-2B viability, S15 LDH release, S16 body weight, and S17 hemolysis."
    ],
    "severity": "blocking",
    "source_locators": [
      "xml:p:15",
    ...
    "ticket_id": "rwk-PMC12153049-campaign-r01-BF-PMC12153049-W2-SUPP-TOXICITY-SURFACE-COVERAGE-CONFLATION"
  }
]
...
- pipeline_v2/deepmine/dbaasp_strict_pilot/packets/PMC12153049/analysis/activity_safe_candidate_handoff.json
