...
| --- | ---: |
| Manifest papers | 13 |
| Paper-level source-reviewed complete | 12 |
| Authoritative DBAASP ingest-ready | 0 |
...
| `PMC13013390` | 6 | 6 | all gpt-5.5/xhigh | all 0 | `needs_targeted_rework` | 42 | 6 | 3 | 3 | False |

## Findings

- `paper_not_source_reviewed_complete`: {"paper_id": "PMC13013390", "severity": "hard", "code": "paper_not_source_reviewed_complete", "review_status": "needs_targeted_rework", "worker_run_clean": true}
