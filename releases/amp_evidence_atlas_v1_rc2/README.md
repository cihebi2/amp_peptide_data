...
| `mechanism_claims.tsv` | 4774 | Mechanism evidence claims and direct-assay classifications. |
| `conflicts_and_cautions.tsv` | 49470 | Database discordance/provenance gaps plus paper-level cautions and blockers. |
| `excluded_blocked_papers.tsv` | 97 | Excluded or non-publication-grade papers and reasons. |
